...
from housing.util.util import read_yaml_file,write_yaml_file,load_data,load_preprocessing_object,load_numpy_array_data
...
class ModelEvaluation:
    def __init__(self,model_evaluation_config:ModelEvaluationConfig,
                      ...
                      data_validation_artifct:DataValidationArtifact,
                      model_training_artifact:ModelTrainerArtifact
                 )->ModelEvaluationArtifact:
        try:
            self.model_evaluation_config = model_evaluation_config
            self.data_ingestion_artifact = data_ingestion_artifact
            self.data_validation_artifact = data_validation_artifct
            self.model_trainer_artifact = model_training_artifact
    ...
    def get_best_model(self):
        try:
            ...
            model = load_preprocessing_object(file_path=model_evaluation_file_content[BEST_MODEL_KEY][MODEL_PATH_KEY])
    ...
    def initiate_model_evaluation(self):
        try:
            ...
            trained_model_object = load_preprocessing_object(file_path=trained_model_file_path)
